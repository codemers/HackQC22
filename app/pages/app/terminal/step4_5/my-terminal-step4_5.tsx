...
import { XCircleIcon, ArrowLongRightIcon, MapPinIcon } from "@heroicons/react/20/solid";
  ...
  return (
    <div className="h-screen bg-my-terminal-background bg-cover bg-center overflow-hidden">
      <div className="min-h-3/8 max-h-3/8">
        ...
        <div className="pl-6">
          <h1 className="text-3xl mb-10 text-white">La *pin* est-elle au bon endroit ?</h1>
        </div>
      </div>
