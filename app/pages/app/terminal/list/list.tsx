...
export default function List() {
  ...
  return (
    <Authenticated adminView={true} className="bg-[#FAFAFA] h-full">
      ...
      <Link href="/app/terminal/step1">
        <div className="block m-6 p-3 shadow-md rounded-md bg-white text-[#50B0C6] flex items-center">
          <span>
            <PlusCircleIcon className="w-8 h-8 mr-8 inline-block float-left" />
          </span>
          <span className="font-bold">Ajouter une borne de recharge</span>
        </div>
      </Link>
          ...
          terminals.map((terminal: any) => {
            return (
              <TerminalButton
                ...
                image="/images/terminal-list/terminal-image-test.png"
              />
            );
          })}
      </div>
